...
let orders: Order[] = ([
  ...
  { id: "ord_8", orderNumber: "#1008", customerId: "cust_8", customerName: "Benjamin Hall", date: "2026-04-04", status: "cancelled", paymentStatus: "refunded", total: 84, notes: "Customer requested cancellation after purchase.", shippingAddress: { name: "Benjamin Hall", line1: "245 Birch Dr", city: "Phoenix", region: "AZ", postalCode: "85004", country: "USA" }, lineItems: [{ id: "li_17", productId: "prod_8", productName: "Desk Lamp", quantity: 1, price: 84 }] },
